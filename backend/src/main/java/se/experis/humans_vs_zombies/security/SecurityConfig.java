...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors()
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/game/{gameId}/squad/{squadId}/check-in").permitAll()
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/game/{gameId}/player/email").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/game/{gameId}/squad/{squadId}/join").permitAll()
                .antMatchers(HttpMethod.DELETE, "/api/v1/game/{gameId}/squad/{squadId}/leave/{playerId}").permitAll()
                ...
                .antMatchers(HttpMethod.PATCH, "/api/v1/game/**").hasRole("Administrator")
